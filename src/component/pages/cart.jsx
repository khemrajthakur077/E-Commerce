    ...
    <>
      <div className='flex justify-center items-center min-w-[280px] '>
        <div  className=''>
           ...
           <p className='absolute top-2 left-2 bg-[#DB4444] w-[55px] h-[22px] text-center rounded text-white'>{props.discount}</p>   {/*change */}
           ...
           <div className='flex gap-3'><p>{props.price}</p> <p className='line-through text-[#CFCFCF]'>{props.oldprice}</p></div> {/*change */}
